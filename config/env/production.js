...
module.exports = {
    ...
    ***************************************************************************/
    default: {
      ...
      ****************************************************************************/
      //ssl: true,
      adapter: 'sails-mysql',
      url: 'mysql://ytchanger:12345678@localhost:3306/ytchanger',
    },
  ...
  ***************************************************************************/
  session: {
    secret: '43dbde77c618e497027d4226ce121ebb',
    /***************************************************************************
    *                                                                          *
  ...
  **************************************************************************/
  ...
  ssl: {
    ca: require('fs').readFileSync(
      require('path').resolve(__dirname,'../ssl/rootCA.crt')
    ),
    key: require('fs').readFileSync(
      require('path').resolve(__dirname,'../ssl/ytchanger.key')
    ),
    cert: require('fs').readFileSync(
      require('path').resolve(__dirname,'../ssl/ytchanger.crt')
    )
  },
  ...
  ***************************************************************************/
  custom: {
    baseUrl: 'https://ytchanger.com',
    internalEmailAddress: 'admin@ytchanger.com',
